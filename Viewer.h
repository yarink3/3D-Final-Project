...
#include <tutorial/sandBox/AudioPlayer.h>
    ...
    namespace opengl
    {
        namespace glfw
        {
            ...
            public:
                ...
                IGL_INLINE void init(int level );
...
//    std::vector<ViewerPlugin*> plugins;
            ...
            public:
                ...
                void collapse();
                void rotateCylinder(int index, Eigen::Vector3f rot, float angle);
                Eigen::Vector3f getTip(int index);
                Eigen::Vector3f getP();
                Eigen::Vector3f getNewRotationVector(int indexOfLink);
                ...
                Eigen::Matrix3f getParentsRotationMatrixes(int indexOfLink);

                Eigen::Matrix3f getParentsTouts(int indexOfLink);

                double getYTheta(int index);

                void init4();

                void drawBox(Eigen::AlignedBox<double ,3> *pAabb,int index, Eigen::RowVector3d a);

                void drawBox2();

                Eigen::RowVector3f getRandomLocation();

                void drawInGreen(int i);
                ...
                void finishLevel(bool timePassed);

                time_t start;

                void clearDataAndMeshes();


                void drawInYellow(int index);

                bool finishedGameByCheating=false;

                void loadCheckCube();

                unsigned int right_view;
                unsigned int left_view;
                std::vector<igl::opengl::ViewerCore> *coreList;
            };
